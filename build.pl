...
home_page(Blogs) :-
    ...
    Head = [title('~yeray'), script([defer, src('https://umami.yerayliloaiza.cc/script.js'), 'data-website-id'('18f64e61-7751-47d3-ad01-44f7532d3015')], []), link([rel('icon'), type('image/svg+xml'), href('/images/favicon.svg')]), \page_style],
